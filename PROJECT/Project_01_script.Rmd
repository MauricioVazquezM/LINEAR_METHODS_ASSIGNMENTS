...
```{r, fig.align='center', fig.width=3.5, fig.height=2.5, echo=FALSE}
...
plot4 <- ggplot(muestreado, aes(x = Residuales, y = X_3)) +
  geom_point(alpha = 0.7) +
  labs(title = "vs. xtr_activitie", x = "Residuales", y = "xtr_activities") +
  theme_minimal()
...
Dado que el $p_{value}$ es mayor a 0.05, en la prueba Shapir-Wilk, no se rechaza la hipótesis nula. Esto indica que los residuos del modelo pueden considerarse normalmente distribuidos. Por lo tanto, ahora mas formalmente, podemos decri que se cumple este supuesto.
