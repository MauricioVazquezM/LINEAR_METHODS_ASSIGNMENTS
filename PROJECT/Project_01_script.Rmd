...
Como podemos observar, tenemos las siguientes columnas: 
...
resultados_parte1 %>%
  kable(caption = "Analisis univariado de los datos pt I", booktabs = TRUE) %>%
  kable_styling(latex_options = c("striped", "hold_position"))

resultados_parte2 %>%
  kable(caption = "Analisis univariado de los datos pt. II", booktabs = TRUE) %>%
  kable_styling(latex_options = c("striped", "hold_position"))
